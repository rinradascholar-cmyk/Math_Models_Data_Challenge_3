...
num_of_sets = 999 # Change value to change how often it loops
timer = 0
...
df.to_csv(r'C:\Users\rinra\Downloads\Data Challenge 3\coin_flip_simulation.csv', index=False)



# Way to extract and see the longest results array
